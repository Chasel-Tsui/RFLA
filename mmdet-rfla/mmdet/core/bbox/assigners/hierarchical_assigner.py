...
class HieAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        bboxes2 = self.prior_decay(bboxes, self.ratio)
        ...
        # limit the positive samples inside a certain circle, it is useful for retinanet, default: False
        if self.inside==True:
    ...
    def prior_decay(self, bboxes, ratio):
